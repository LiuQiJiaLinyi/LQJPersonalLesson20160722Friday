...
-(void)buildUI
{
    ...
    for (int i = 0; i <3; i++) {
        ...
        [tempTable registerClass:[DetailCourseTableCell class] forCellReuseIdentifier:reuseID];
...
{
    DetailCourseTableCell * cell = [tableView dequeueReusableCellWithIdentifier:reuseID];
    
    if (cell == nil) {
        cell = [[DetailCourseTableCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseID];
    }
